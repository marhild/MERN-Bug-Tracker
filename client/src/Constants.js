...
export const CONTACTS_HOME = '/categories'
...
export const MOD_EMAIL = 'ModeratorModerator@gmail.com'
export const ADMIN_EMAIL = 'AdminAdmin@gmail.com'
export const ADMIN_PW = 'password'
export const MOD_PW = 'password'
